...
//     // choose a random cars
//     let randomIndex = Math.floor(Math.random() * carss.length);
//     let randomCars = carss[randomIndex];

//     res.status(200).send(randomCars);
// }

// <!--
//   <button id="babyButton">Baby Names</button>
//   <button id="foodButton">Foods</button>
//   <button id="CarsButton">Car Brands</button> -->
